...
<!-- Side-bar Navigation -->
    <div class="flex h-full sticky left-0">
...
@endif
        <div class="flex flex-col mx-auto max-w-4xl px-4 sm:px-6 lg:max-w-7xl">
            ...
            <div id="papertrails" class="tab-content hidden items-center">
                <div class="flex flex-none flex-col text-center w-auto items-center h-12 mt-4">
                    ...
                    <table class="w-full border-collapse border border-black text-center self-center text-xs bg-white shadow-md shadow-slate-500">
                        <thead>
                            <tr>
                                <th scope="col" class="border border-black text-black w-[5%]">Office</th>
                                <th scope="col" class="border border-black text-black w-[5%]">In</th>
                                <th scope="col" class="border border-black text-black w-[5%]">Out</th>
                                <th scope="col" class="border border-black text-black w-[5%]">Elapsed Time</th>
                                <th scope="col" class="border border-black text-black w-[5%]">Action</th>
                                <th scope="col" class="border border-black text-black w-[60%]">Remarks</th>
                                <th scope="col" class="border border-black text-black w-[5%]">File</th>
                                <th scope="col" class="border border-black text-black w-[10%]">Drive Link</th>
                            </tr>
                        </thead>
                        <tbody>
                        @foreach($paperTrails as $paperTrail)
                            <tr>
                                <td class="border border-black text-black w-[5%]">{{ $paperTrail->office }}</td>
                                <td class="border border-black text-black w-[5%]">{{ $paperTrail->in_time }}</td>
                                <td class="border border-black text-black w-[5%]">{{ $paperTrail->out_time }}</td>
                                <td class="border border-black text-black w-[5%]">{{ $paperTrail->elapsed_time }}</td>
                                <td class="border border-black text-black w-[5%]">{{ $paperTrail->action }}</td>
                                <td class="border border-black text-black w-[60%]">{{ $paperTrail->remarks }}</td>
                                <td class="border border-black text-black w-[5%]">{{ $paperTrail->file_attach }}</td>
                                <td class="border border-black text-black w-[10%]">{{ $paperTrail->drive }}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
