            ...
            <div class="flex px-2 m-4">
                ...
                <form action="{{ route('admin-offices') }}" method="GET" class="flex items-center ml-10">
                    <div class="relative">
                        ...
                        <select name="order" class="ml-4 p-1 h-8 w-40 border border-black rounded-r bg-slate-300 text-black shadow-md shadow-slate-500">
                    ...
                    <table class="divide-y divide-gray-200 w-full h-full">
                        <thead class="bg-red-700 text-white sticky top-0 inset-0">
                            <tr>
                                ...
                                <th scope="col" class="border border-black">Users per Office</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($offices as $office)
                                <tr class="bg-white text-black h-10">
                                    ...
                                    <td class="border border-black">{{$office->users_count}}</td>
                                    <td class="border border-black">{{$office->created_at}}</td>
                                    <td class="border border-black">{{$office->updated_at}}</td>
        ...
        <div class="relative bg-white rounded-lg shadow-lg p-8 w-[500px] inset-x-[550px] inset-y-[150px]">
            ...
            @csrf
                <div>
                    ...
                    <input type="text" id="code" name="code" class="rounded-full bg-slate-200 text-black w-full pl-3 shadow-md shadow-slate-500 mb-1" required><br>
                ...
                <div class="flex justify-end">
                    ...
                    <button type="submit" class="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">Add Office</button>
                </div>
            </form>
        </div>
    </div>
