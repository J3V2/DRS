            ...
            <div class="max-w-7xl bg-white mx-auto px-4 sm:px-6 lg:px-8 h-auto w-auto mt-16 rounded-md shadow-md shadow-slate-500 relative m-4">
                ...
                @csrf
                    <div>
                        ...
                        <textarea rows="3" cols="45" id="description" name="description" value="{{ $type->description }}" class="rounded resize-none bg-slate-200 text-black w-full pl-3 shadow-md shadow-slate-500 mb-2" required></textarea><br>
