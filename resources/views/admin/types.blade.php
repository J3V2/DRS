        ...
        <div class="flex-auto flex flex-col">
            <div class="flex bg-white mt-8 rounded-md shadow-md shadow-slate-500 mx-10 w-[1200px]">
                <div class="flex px-2 m-4">
                    ...
                    <form action="{{ route('admin-types') }}" method="GET" class="flex items-center ml-10">
                        <div class="relative">
                                ...
                                <tr class="bg-white text-black h-10">
                                    ...
                                    <td class="border border-black">
                                        <div class="flex justify-center self-center font-bold text-black">
                                            ...
                                            <button type="submit" class="size-11/12 p-1 rounded-md bg-green-300 hover:bg-green-500" onclick="confirmActivate('/admin/types/activate/{{ $type->id }}')">
                                                Activate
                                            </button>
                                            @else
                                            <button type="submit" class="size-11/12 p-1 rounded-md bg-red-300 hover:bg-red-500" onclick="confirmDeactivate('/admin/types/deactivate/{{ $type->id }}')">
                                                Deactivate
                                            </button>
                                            @endif
                                        </div>
...
<!-- Script goes here!! -->
    <script>
        ...
        function confirmActivate(url) {
            if (confirm('Are you sure you want to Activate the status of this Document Type?')) {
                window.location.href = url;
            }
        }
        function confirmDeactivate(url) {
            if (confirm('Are you sure you want to Deactivate the status of this Document Type?')) {
                window.location.href = url;
            }
        }
