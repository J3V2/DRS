...
<body class="flex items-center justify-center h-screen w-screen bg-gray-200">
    ...
    <div class="relative h-auto w-full md:w-1/2 lg:w-1/3 p-8 bg-white rounded-lg shadow-lg">
        ...
        <div class="flex flex-col items-center justify-center">
            ...
            <h2 class="text-3xl font-bold text-indigo-800 mb-2">Forgot Password</h2>
        </div>
        ...
        @csrf
            ...
            <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold p-2 w-full border rounded-md">Forgot</button>
            <br>
