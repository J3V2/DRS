            ...
            <div class="flex flex-auto flex-col">
                <div class="flex bg-white mt-8 rounded-md shadow-md shadow-slate-500 mx-10 w-[1200px]">
                    ...
                    <div class="text-start row-span-2">
                        <h2 class="text-indigo-800 font-bold text-4xl">My Reports</h2>
                        <h4 class="text-indigo-800 font-semibold text-sm"><a href="{{route('user-my-docs')}}" class="text-sm text-black">My Documents </a><a href="{{route('user-my-reports')}}"> > My Reports</a></h4>
                    </div>
                </div>
            </div>

            <div class="bg-white mt-8 rounded-md shadow-md shadow-slate-500 justify-center mx-10 w-[1200px] h-1/12">
                <div class="overflow-auto self-center text-center m-8 rounded-md shadow-md shadow-slate-500">
