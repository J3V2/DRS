...
<head>
    ...
    <title>My Tracking Numbers</title>
</head>
                ...
                <div class="flex h-auto self-center text-center m-4 flex-row space-x-20">
                    ...
                    <form action="{{ route('invalidate-tracking-number') }}" method="post">
                        ...
                        <div class="bg-indigo-100 rounded border border-indigo-400 flex items-center w-auto">
                            <input type="text" id="invalidate" name="invalidate" placeholder="XXXX-XXXX-XXXX-XXXX" class="bg-transparent py-1 text-black px-1 focus:outline-none w-full" />
                            <button type="submit" class="w-52 py-2 inline-flex items-center justify-center bg-indigo-600 text-white font-bold rounded-r border-r border-indigo-700 hover:bg-indigo-800 active:bg-indigo-300 disabled:opacity-50">
                                <span class="material-icons-sharp inline-block align-middle mr-2">
                                    cancel
                                </span>
                                Invalidate
