            ...
            <div class="flex bg-white mt-8 rounded-md shadow-md shadow-slate-500 mx-10 w-[1200px]">
                <div class="flex px-2 m-4">
                    <div class="row-start-1 row-span-2">
                        <h2 class="text-indigo-800 font-bold text-4xl">For Releasing</h2>
                        <h4 class="text-indigo-800 font-semibold text-sm"><a href="{{route('user-office-docs')}}" class="text-sm text-black">Office Documents </a><a href="{{route('user-for-releasing')}}"> > For Releasing</a></h4>
                    </div>
                    <form action="{{ route('user-for-releasing') }}" method="GET" class="flex items-center ml-10">
                        <div class="relative">
                        ...
                        <button type="submit" class="ml-52 p-1 h-8 w-auto border border-black rounded-md bg-slate-300 text-black shadow-md shadow-slate-500">
                            Search
                        </button>
                    </form>
                </div>
            ...
            <div class="bg-white mt-8 rounded-md shadow-md shadow-slate-500 justify-center mx-10 w-[1200px] h-4/6">
                <div class="overflow-auto self-center text-center m-8 h-[79%] rounded-md shadow-md shadow-slate-500">
                    ...
                    <div class="flex flex-col items-center justify-center h-full">
                        ...
                        <p class="text-center text-lg font-bold text-red-600">There are No "For Releasing" Documents at the moment in your Office.</p>
                    </div>
                    @else
