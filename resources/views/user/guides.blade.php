        ...
        <div class="w-64 bg-indigo-800 shadow-lg text-white w-[250px] h-screen">
            <div>
                <ul class="mt-8">
                    ...
                    <li class="relative">
                        <a href="{{route('user-guides')}}" class="flex items-center gap-x-2 text-sm px-12 py-1 bg-indigo-900 w-full">
                            <span class="material-icons-sharp text-base">
                                question_mark
                            </span>
                            <span>DRS Guide</span>
...
@endif
        <div class="flex flex-auto flex-col">
            <div class="flex bg-white mt-8 rounded-md shadow-md shadow-slate-500 mx-10 w-[1200px]">
                <div class="flex px-2 m-4">
                    <div class="text-start row-span-2">
                        <h2 class="text-indigo-800 font-bold text-4xl">DRS Guide</h2>
                    </div>
                </div>
            </div>
            @if(session('success'))
            ...
            @endif
            <div class="flex bg-white w-[1200px] h-4/6 mt-8 rounded-md shadow-md shadow-slate-500 justify-center mx-10">
            </div>
        </div>
    </div>
<!-- Script goes here!! -->
