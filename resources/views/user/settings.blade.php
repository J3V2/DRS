        ...
        <div>
            <ul class="mt-8">
                ...
                <li class="relative pt-32">
                    <a href="{{route('user-settings')}}" class="flex items-center gap-x-2 text-sm px-12 py-1 bg-indigo-900 w-full">
...
<!-- Main Content -->
        ...
        @endif
            <div class="flex flex-auto flex-col">
                ...
                <!-- Messages -->
                @if ($errors->any())
                    <div class="alert alert-danger relative bg-red-300 text-center text-red-800 font-bold text-base w-full">
                        <ul>
                ...
                @endif
                <div class="flex bg-white w-1/2 h-3/6 self-center mt-8 rounded-md shadow-md shadow-slate-500 justify-center">
                    <form class="w-full" action="{{ route('user-update-password') }}" method="POST">
                        @csrf
                        <div class="p-4">
